...
/*
	...
	Перебираем исходный слайс с температурами.
	Вычисляем минимальное целое число для каждого элемента, и обнуляем значение в первом разряде. Это будет ключом в мапе.
	По этому ключу добавлем теппературу в мапу.
	Выводим мапу.
